...
const createSendToken = (user, statusCode, req, res) => {
  ...
  const cookieOptions = {
    ...
    httpOnly: true,
    secure: req.secure === true || req.headers['x-forwarded-proto'] === 'https', // cookies send via secure connection only in production mode
  };
...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  // const url = 'http://127.0.0.1:8000/me'; // Hardcoded url
